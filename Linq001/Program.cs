...
using static Linq001.ListGenerator;
...
namespace Linq001
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var Dig = Arr.Where((p, i) => p.Length < i);
            ...
            var name = ProductList.Select(n => n.ProductName);
            name = from n in ProductList
            ...
            var re = ProductList.Select(p => new { Price = p.UnitPrice });
            ...
            var VaildPostion = Arr2.Where((value, index) => value == index);

            foreach (var num in VaildPostion)
            {
            ...
            var resl = numbersA.SelectMany(a=> numbersB,(a,b)=>new {a,b}).Where(resl => resl.a < resl.b);
            Console.WriteLine("Pairs where a < b:");
            foreach (var pair in resl )
            {
            ...
            var ord = CustomerList.SelectMany(c => c.Orders)
            ...
            var order = CustomerList.SelectMany(c => c.Orders)
